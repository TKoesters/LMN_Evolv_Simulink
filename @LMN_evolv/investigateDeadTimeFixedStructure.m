function [resultsDeadTime,obj] = investigateDeadTimeFixedStructure(obj,inputs2investigate,deadTimeRanges)
...
parfor i = 1 : N
    ...
    for ii = 1:length(inputs2investigate)
    ...
    objTemp = objTemp.trainGivenStructure;
...
bestLMN = bestLMN.trainGivenStructure;
